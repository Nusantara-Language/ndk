...
void nusantara::PenganalisisSemantik::kunjungiTitikPanggilFungsi(const Titik& titik)
{
  ...
  {
    this->pengecualianSintaks.tambahData({namaFungsiToken.lokasiBerkas, namaFungsiToken.lokasi, namaFungsiToken.konten, __NK__LABEL_KELUARAN_AS__ "fungsi '" + namaFungsiToken.konten + "' belum dibuat."}); // function tambahData
  } // if
