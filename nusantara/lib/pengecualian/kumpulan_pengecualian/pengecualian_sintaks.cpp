...
nusantara::PengecualianSintaks::PengecualianSintaks(const std::vector<DataPengecualianSintaks>& kumpulanData) : APengecualian(__NK__LABEL_KELUARAN_CUSTOM__("Class PengecualianSintaks") "Pesan pengecualian belum dibuat."), kumpulanData(kumpulanData) {} // constructor PengecualianSintaks

nusantara::PengecualianSintaks::PengecualianSintaks(const DataPengecualianSintaks& data) : PengecualianSintaks(std::vector<DataPengecualianSintaks>{data}) {} // constructor PengecualianSintaks
