...
void nusantara::PemecahSintaks::buatBanyakToken()
{
  while (this->konten.size() > 0)
  {
    ...
    {
      this->pengecualianSintaks.tambahData({token.lokasiBerkas, token.lokasi, token.konten, __NK__LABEL_KELUARAN_TS__ "Karakter tidak di ketahui."}); // function tambahData
    }
