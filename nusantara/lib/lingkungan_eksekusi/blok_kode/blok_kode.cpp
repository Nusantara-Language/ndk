...
nusantara::BlokKode::BlokKode(KumpulanFungsi&& kumpulanFungsi, KumpulanIntruksi&& kumpulanIntruksi) : kumpulanIntruksi(std::move(kumpulanIntruksi)), kumpulanFungsi(std::move(kumpulanFungsi)) {} // constructor BlokKode
