...
nusantara::Fungsi::Fungsi(const std::string& nama) : nama(nama), blokKode({}, {}) {}

nusantara::Fungsi::Fungsi(const std::string& nama, BlokKode&& blokKode) : nama(nama), blokKode(std::move(blokKode)) {}
