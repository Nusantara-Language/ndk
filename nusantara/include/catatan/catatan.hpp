...
class Catatan
{
  ...
  {
  #if defined(__NK__CATATAN_DEBUG__) || defined(__NK__CATATAN_INFO__) || defined(__NK__CATATAN_PERINGATAN__) || defined(__NK__CATATAN_KESALAHAN__) || defined(__NK__CATATAN_KESALAHAN_FATAL__)
    #ifdef __NK__CATATAN_SIMPAN_BERKAS__
    ...
    case DEBUG:
      ...
      std::cout << "\033[1;34m[DEBUG]\033[0m " << pesan << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
      file << "[DEBUG] " << pesan << "\n";
      #endif
    ...
    case INFO:
      ...
      std::cout << "\033[1;33m[INFO]\033[0m " << pesan << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
      file << "[INFO] " << pesan << "\n";
      #endif
    ...
    case PERINGATAN:
      ...
      std::cout << "\033[1;38;5;208m[PERINGATAN]\033[0m " << pesan << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
      file << "[PERINGATAN] " << pesan << "\n";
      #endif
      break;
    #endif
    ...
    case KESALAHAN:
      ...
      std::cout << "\033[1;31m[KESALAHAN]\033[0m " << pesan << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
      file << "[KESALAHAN] " << pesan << "\n";
      #endif
      break;
    #endif
    ...
    case KESALAHAN_FATAL:
      ...
      std::cout << "\033[0;31m[KESALAHAN_FATAL]\033[0m " << pesan << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
      file << "[KESALAHAN_FATAL] " << pesan << "\n";
      #endif
      break;
    #endif
    default:
  ...
  static void cetak(const TipeCatatan& tipe, const Types&... kumpulanPesan)
  {
    ...
    case INFO:
      #ifdef __NK__CATATAN_CETAK_INFO__
      std::cout << "\033[1;33m[INFO]\033[0m ";
      ((std::cout << kumpulanPesan), ...);
      std::cout << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
    ...
    case PERINGATAN:
      #ifdef __NK__CATATAN_CETAK_PERINGATAN__
      std::cout << "\033[1;38;5;208m[PERINGATAN]\033[0m ";
      ((std::cout << kumpulanPesan), ...);
      std::cout << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
    ...
    case KESALAHAN:
      #ifdef __NK__CATATAN_CETAK_KESALAHAN__
      std::cout << "\033[1;31m[KESALAHAN]\033[0m ";
      ((std::cout << kumpulanPesan), ...);
      std::cout << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
    ...
    case KESALAHAN_FATAL:
      #ifdef __NK__CATATAN_CETAK_KESALAHAN_FATAL__
      std::cout << "\033[0;31m[KESALAHAN_FATAL]\033[0m ";
      ((std::cout << kumpulanPesan), ...);
      std::cout << "\n";
      #endif
      #ifdef __NK__CATATAN_SIMPAN_BERKAS__
      file << "[KESALAHAN_FATAL] ";
      ((file << kumpulanPesan), ...);
      file << "\n";
      file.close();
      #endif
